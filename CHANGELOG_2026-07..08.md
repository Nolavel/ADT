# Changelog — 2026-06 … 2026-08-14 (archive)

Split out of `CHANGELOG.md` on 2026-09-03 (work plan Task 4). **Nothing here was
edited, only moved**: the main log had reached 405 KB across 111 entries, which
is a document nobody reads, and the entries that made it that size are the ones
that should have been post-mortems (`docs/postmortems/`).

Newest first, same as the main file. For anything dated 2026-08-15 or later see
[`CHANGELOG.md`](CHANGELOG.md); for how the project works **now**, `CLAUDE.md` is
authoritative and neither of these logs is.

> *Архив: записи до 2026-08-15, перенесены без правок.*
