...
## Было 500 при полукарте 1750 — то есть разворот начинался на 1250 от центра
## и играбельной оставалась едва половина площади карты. Остров целиком лежит
## в пределах 1300 от центра, так что 500 отжимали игрока от собственного
## берега. 120 оставляет всю карту, но не даёт вылететь в пустой океан.
